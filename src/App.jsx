    ...
    <>
      <div className="min-h-full">
        ...
        <div className="py-10">
          ...
          <main className="">
            <div className="grid grid-flow-col grid-cols-3 mx-auto max-w-7xl sm:px-6 lg:px-8">
            
              <AllStores className="col-span-2 bg-white shadow-xl min-h-4" />
            </div>
          </main>
         
          <StoreCard className="col-span-2 bg-white shadow-xl min-h-4" />
